...
<template>
  <main>
    ...
    <section class="mb-8 py-20 text-white text-center relative">
      <div
        class="absolute inset-0 w-full bg-contain introduction-bg"
      ...
      <div class="container mx-auto">
        <div class="text-white main-header-content">
          ...
          <p class="w-full md:w-8/12 mx-auto">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. In nam eius asperiores quia
            ipsa eveniet at, neque culpa et ex error voluptatem. Incidunt hic tempora modi quis?
            Porro, iste adipisci.
          </p>
        </div>
      </div>
